...
# Bootstrap sys.path so the script form
# (`python scripts/load_csf_tier_questionnaires.py`) resolves `app` and
# `scripts` packages the same way the module form
# (`python -m scripts.load_csf_tier_questionnaires`) does. parents[1] is apps/api.
